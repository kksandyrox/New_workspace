...
// httpd a web server object, createServer is a function if http module.
var io = require('socket.io').listen(httpd);
//bind the socket object to the web server object
var fs = require('fs');
//a file system module used to read the file.
var usernames = [];
var users = {};

httpd.listen(4000);
//listen for new webclients on port 4000
